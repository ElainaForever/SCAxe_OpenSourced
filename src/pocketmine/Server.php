...
class Server{
   ...
   §e生存斧服务器Minecraft PE 0.14.x核心§f.
   §bVERSION: §62.7
   §a本核心以Genisys为基础，部分代码来自PM其它项目.
   §c作者QQ：kkk §f&§c 2125696621
			';
			...
			$nowLang = $this->getProperty("settings.language", "chs");
			...
			if(file_exists($this->filePath . "src/pocketmine/resources/genisys_$lang.yml")){
				...
				$content = file_get_contents($file = $this->filePath . "src/pocketmine/resources/genisys_chs.yml");
			}
